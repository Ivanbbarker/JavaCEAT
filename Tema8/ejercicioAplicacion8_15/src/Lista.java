...
class Lista {
    ...
    public boolean equals(Lista listilla2){
        boolean iguales = (tabla.length==listilla2.tabla.length);
        if(iguales){
            for(int i=0;i<tabla.length && iguales;i++){
                if(tabla[i]!=listilla2.tabla[i]){
                    iguales = false;
                }
            }
        }
